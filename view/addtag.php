    ...
    <header class=" bg-gradient-to-tr from-rose-100 to-teal-100 h-screen flex flex-col justify-around items-center">
        ...
        <div class="w-3/4 flex justify-between items-center ">
            <div class="w-3/5	 ">
                ...
                <form class="max-w-sm mx-auto" method="post" action="../controller/addtag.php">
                    <span class="my-5 flex text-1xl font-extrabold text-gray-900  md:text-2xl lg:text-3xl">Creer un tag
                        <div class="w-2 h-2 rounded-full bg-green-700">
                        </div>
                    </span>
                    <div class="mb-5">
                        <label class="block mb-2 text-sm font-medium text-gray-900">Tag</label>
                        <input type="text" name="tag" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required>
                    </div>
