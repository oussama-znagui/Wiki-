    ...
    <header class="min-h-screen bg-gradient-to-tr from-rose-100 to-teal-100 h-auto p-10 flex flex-col justify-around items-center">
        ...
        <div class="w-3/4 lg:flex justify-center items-center ">
            <div class="lg:w-3/5">
                ...
                <form class="my-5 mx-auto bg-gray-100 p-5 rounded-3xl" method="post" action="../controller/addwiki.php">
                    ...
                    <h1 class="text-center block mb-2 text-3xl font-extrabold text-gray-900 dark:text-white">Tags</h1>
                    <div class="p-4 rounded-3xl bg-blue-300 grid grid-cols-1 md:grid-cols-3 gap-4 w-4/5 m-auto my-5 ">
                        ...
                        ?>
                            <div class="flex items-center mb-4">
                                <input name="tags[]" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded ">
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800  ">Publier</button>
                </form>
