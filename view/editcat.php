...
$idCat = $_GET['cat'];
// echo $idCat;
$categorie = new Categorie($idCat, null, null);
...
<body>
    <header class=" bg-gradient-to-tr from-rose-100 to-teal-100 h-screen flex flex-col justify-around items-center">
        ...
        <nav class="flex justify-between items-center w-3/4">
            ...
            <ddiv class="flex items-center gap-6">
        ...
        <div class="w-3/4 flex justify-between items-center ">
            <div class="w-3/5	 ">
                ...
                <form class="max-w-sm mx-auto" method="post" action="../controller/editcat.php?cat=<?php echo $categorie->__get('id_cat') ?>">
                    <span class="my-5 flex text-1xl font-extrabold text-gray-900  md:text-2xl lg:text-3xl">Modifier une categorie
                        <div class="w-2 h-2 rounded-full bg-green-700">
                        </div>
                    </span>
                    <div class="mb-5">
                        <label class="block mb-2 text-sm font-medium text-gray-900">Categorie</label>
                        <input type="text" value="<?php echo $categorie->__get('titre') ?>" name="cat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required>
                    </div>
                    <div class="mb-5">
                        <label class="block mb-2 text-sm font-medium text-gray-900">Description</label>
                        <textarea type="password" name="content" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required><?php echo $categorie->__get('description') ?></textarea>
                    </div>


                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Modifier la categorie</button>
                </form>
